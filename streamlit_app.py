...
def init_from_link_token():
    ...
    try:
        ...
        emp_df = session.sql(f"""
            SELECT EMPCODE, LASTNAME, FIRSTNAME, COMPANYNAME, DEPNAME, POSNAME
...
def interview_intro():
    ...
    st.write("""Ярилцлагын үндсэн үе шат болон зөвлөмжийн дагуу ярилцлагаа эхлээрэй:
            Бэлтгэл үе шат:
                Ярилцлага хийх ажилтны нэр, ажлаас гарах үеийн судалгаа бөглөгдсөн эсэхийг шалгаж үзэх
                Ярилцлагын цаг, орчинг урьдчилан бэлдэн итгэлцэлтэй, тайван орчин бүрдүүлэх
                Ярилцлагын асуултуудтай урьдчилан танилцаж бэлдэх
            Танилцуулах үе шат
                Ярилцлагын зорилгыг товч танилцуулах
                Ярилцлагын Нууцлал болон үр дүнг хэрхэн ашиглах талаар тайлбарлах
            Ярилцлагын үе шат
                Шууд гол асуултаар эхлэлгүй, Ажлаа хүлээлгэж өгөхөд хэр байна?  гэх мэт хөнгөн сэдвээр яриаг эхлүүлж, ажилтныг тайвшруулсны дараа гол асуултаа асууж эхлээрэй.
                Ажилтны нүдрүү нь эгц харах /ширтэж болохгүй/, ярьж буй сэдвийг нь дэмжиж толгой тохих гэх мэт биеийн хэлэмж гаргах нь таныг сонсож байна гэсэн сэтгэгдэл төрүүлнэ.
                Сонсогч байж ажилтны илүү их яриулах. Яриаг нь тасалж болохгүй.
                5 Яагаад" техник (5 Why) ашиглаарай: Хэрэв ажилтан "Удирдлагатайгаа таарамжгүй байсан" гэвэл, шууд орхихгүйгээр "Яг ямар тохиолдолд үл ойлголцол үүсдэг байсан бэ?", "Тэр үед танд ямар санагдсан бэ?" гэх мэтээр гүнзгийрүүлж асууна.
                Ажилтны шүүмж болон санал хүсэлтийг зөвхөн тэмдэглэж аваарай. Санал зөрөх эсвэл хэлсэн санал, гомдлыг нь шууд шүүж тунгаах нь ярилцлагыг үргэлжлүүлэхэд хүндрэлтэй болгоно.
                Ажилтны биеийн хэлэмж, сэтгэл хөдлөлийг анхааралтай ажиглан өөрийн үнэлгээгээ өгөөрэй.
                Ажилтны хэлсэн бүх зүйлийг үг бүрчлэн бичих гэж хичээх хэрэггүй. Энэ нь ярилцлагын амьд харилцааг үгүй хийдэг. Гол санаа, чухал нэрс, тоо баримтыг л тэмдэглэж аваарай.
            Талархал илэрхийлэх, дуусгах үе шат
                Ажилтны хэлсэн чухал санаануудыг товч дүгнэж, зөв ойлгосон эсэхээ бататгана.
                "Таны өгсөн эдгээр санал, шүүмж манай компанийн ирээдүйн хөгжилд маш чухал хувь нэмэр оруулна. Цаг гаргаж, үнэн сэтгэлээсээ ярилцсанд баярлалаа." гэх мэт талархал илэрхийлээрэй.
                Ажилтны дараагийн ажил, карьерт нь амжилт хүсэн эерэг сэтгэгдэл үлдээснээр Employee branding-г сайжруулах, тухайн ажилтныг эргэн ажилд авах боломжтой.
                 """
    )
